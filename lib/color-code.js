    ...
    ***************************************************************************** */
    ...
    var ColorCodeImageEntity = (function (_super) {
        ...
        ColorCodeImageEntity.prototype.draw = function (context) {
            ...
            if (isDefined(image)) {
                ...
                context.drawImage(this._prevImage, this.x - this.scene.camera.x, this.y - this.scene.camera.y, this.width * this.getScale().x, this.height * this.getScale().y);
                context.scale(1, 1);
            }
            context.setTransform(1, 0, 0, 1, 0, 0);
            if (this.scene.game.debug)
        ...
        ColorCodeImageEntity.prototype.getImageData = function (image) {
            ...
            var changeColor = Array.from(this._changeColorMap.keys());
            var _loop_1 = function (i) {
                var toColor = this_1._changeColorMap.get(changeColor.find(function (rgb) {
                ...
                if (toColor) {
                    ...
                    if (!this_1._keepAlpha)
                        imageData.data[i + 3] = this_1._imageAlpha;
                }
            };
            var this_1 = this;
    ...
    var ColorCodeSpriteEntity = (function (_super) {
        ...
        ColorCodeSpriteEntity.prototype.getImageData = function (image) {
            ...
            canvas.style.imageRendering = isChromium() ? "pixelated" : "crisp-edges";
            var context = canvas.getContext("2d");
            context.drawImage(image, this.sprite.x, this.sprite.y, this.sprite.width, this.sprite.height, 0, 0, this.width, this.height);
            var imageData = context.getImageData(0, 0, canvas.width, canvas.height);
            var changeColor = Array.from(this._changeColorMap.keys());
            var _loop_1 = function (i) {
                var toColor = this_1._changeColorMap.get(changeColor.find(function (rgb) {
